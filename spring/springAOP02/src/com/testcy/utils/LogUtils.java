...
public class LogUtils {
     ...
     * 切入点表达式的重用
     */
    @Pointcut("execution(public * com.testcy.impl.MyMathCalculator.*(int,* ))")
    public void myPoint() {
    }
    ...
    public static void logStart(JoinPoint joinPoint) {
        ...
        System.out.println("普通前置通知【 " + methodName + " 】方法执行开始了！。。。参数列表是：" + "【" + Arrays.asList(args) + "】");
    }
     ...
     * @param result
     */
    @AfterReturning(value = "execution(public * com.testcy.impl.MyMathCalculator.*(int,* ))", returning = "result")
    public static void logReturn(JoinPoint joinPoint, Object result) {

        System.out.println("普通返回通知【" + joinPoint.getSignature().getName() + "】方法执行正常完成了！。。。计算结果是：" + "【" + result + "】");
    }
     ...
     * @param e
     */
    @AfterThrowing(value = "execution(public * com.testcy.impl.MyMathCalculator.*(int,* ))", throwing = "e")
    public static void logExecption(JoinPoint joinPoint, Exception e) {

        System.out.println("普通异常通知方法【" + joinPoint.getSignature().getName() + "】执行异常了，异常信息是：" + "【" + e + "】");
    }
     ...
     */
    @After("execution(public * com.testcy.impl.MyMathCalculator.*(int,* ))")
    private int logEnd(JoinPoint joinPoint) {

        System.out.println("普通后置通知方法【" + joinPoint.getSignature().getName() + "】执行最终结束了！");
        return 0;
    }
